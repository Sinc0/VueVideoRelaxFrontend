...
<style scoped>
 ...
 #defaultRooms { display: inline-flex; flex-direction: column; padding-bottom: 10px; overflow: hidden; scrollbar-width: thin; border: 0px solid white; }
 #defaultRoomsTitle { width: auto; margin: 0px; padding: 0px; opacity: 0.8; font-size: 14px; } 
 #activeRoomsTitle { width: auto; margin: 0px; padding: 0px; opacity: 0.8; font-size: 14px; }
